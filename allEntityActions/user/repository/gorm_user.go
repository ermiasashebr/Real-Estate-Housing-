...
func (feedbackRepo *UserGormRepo) Feedbacks() ([]entity.Feedback, []error) {
	feedbacks := []entity.Feedback{}
	errs := feedbackRepo.conn.Find(&feedbacks).GetErrors()
	//log.Println("properties", errs)
	if len(errs) > 0 {
		return nil, errs
	}
	return feedbacks, errs
}
...
func (feedbackRepo *UserGormRepo) Feedback(id uint) (*entity.Feedback, []error) {
	feedback := entity.Feedback{}
	errs := feedbackRepo.conn.First(&feedback, id).GetErrors()
	if len(errs) > 0 {
		return nil, errs
	}
...
func (feedbackRepo *UserGormRepo) UserFeedback(id uint) ([]entity.Feedback, []error) {
	feedback := []entity.Feedback{}
	log.Println("gorm feedback", feedback)
	errs := feedbackRepo.conn.Where("user_id = ?", id).Find(&feedback).GetErrors()
	log.Println("id uint", id)
	if len(errs) > 0 {
		return nil, errs
	}
...
func (feedbackRepo *UserGormRepo) UpdateFeedback(feedback *entity.Feedback) (*entity.Feedback, []error)  {
	fed := feedback
	errs := feedbackRepo.conn.Save(fed).GetErrors()
	if len(errs) > 0 {
		return nil, errs
	}
	return fed, errs
...
func (feedbackRepo *UserGormRepo) DeleteFeedback(id uint) (*entity.Feedback, []error) {
	fed, errs := feedbackRepo.Feedback(id)

	if len(errs) > 0 {
		return nil, errs
	}
	errs = feedbackRepo.conn.Delete(fed, id).GetErrors()
	if len(errs) > 0 {
		return nil, errs
	}
	return fed, errs
...
func (feedbackRepo *UserGormRepo) StoreFeedback(feedback *entity.Feedback) (*entity.Feedback, []error)  {
	fed := feedback
	errs := feedbackRepo.conn.Create(fed).GetErrors()
	if len(errs) > 0 {
		return nil, errs
	}
	return fed, errs
